...
import { MotingAppClient } from "../contracts/MotingApp";
...
const AppCalls = ({ openModal, setModalState }: AppCallsInterface) => {
  ...
  const sendAppCall = async () => {
    ...
    const appClient = new MotingAppClient(appDetails, algodClient);
    // const deployParams = {
    ...
    const move = Number(contractInput);
    const box_name = encodeUint64(move);
